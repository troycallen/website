...
export async function GET(request: NextRequest) {
  ...
  const redirect_uri = `${process.env.NEXT_PUBLIC_BASE_URL || 'https://troycallen.com'}/api/auth/callback/spotify`
  ...
  try {
    ...
    return NextResponse.json({
      message: 'Success! Copy this refresh_token to your .env.local file:',
